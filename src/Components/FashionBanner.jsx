      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 rounded-3xl overflow-hidden">
        ...
        <div className="relative overflow-hidden rounded-3xl group h-[420px] lg:h-[520px]">
          ...
          <div className="absolute bottom-8 left-8 text-white">
            <span className="bg-[#344E41] text-xs font-bold px-3 py-1 rounded-full dmsans mb-3 inline-block">
            ...
            <Link
              to="/styles"
              className="inline-flex items-center gap-2 bg-white text-[#344E41] px-5 py-2.5 rounded-xl font-bold text-sm hover:bg-[#344E41] hover:text-white transition-all duration-300 cursor-pointer dmsans shadow-lg"
            >
        ...
        <div className="flex flex-col gap-6">
          <div className="relative overflow-hidden rounded-3xl group h-[245px]">
            ...
            <div className="absolute bottom-6 left-6 text-white">
              <span className="bg-[#B7794B] text-xs font-bold px-3 py-1 rounded-full dmsans mb-2 inline-block">
          ...
          <div className="relative overflow-hidden rounded-3xl group h-[245px]">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/65 via-black/15 to-transparent" />
            <div className="absolute bottom-6 left-6 text-white">
              <span className="bg-[#344E41] text-xs font-bold px-3 py-1 rounded-full dmsans mb-2 inline-block">
