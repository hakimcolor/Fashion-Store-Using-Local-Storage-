    ...
    <section className="mt-16 mb-4">
      ...
      <div className="flex justify-center gap-3 mb-7" data-aos="fade-up">
        <button
          ...
          className={`cursor-pointer dmsans text-sm font-semibold px-5 py-2 rounded-full transition-all duration-300 ${
            active === 'related'
              ? 'bg-[#8FA28A] text-white shadow-md'
      ...
      <div className="relative" data-aos="fade-up">
        ...
        <button
          ...
          className="hidden sm:flex absolute -left-4 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg items-center justify-center text-gray-700 dark:text-white hover:bg-[#8FA28A] hover:text-white hover:border-[#8FA28A] transition-all duration-300 cursor-pointer"
        >
          <svg
            className="w-4 h-4"
            fill="none"
            ...
            >
              ...
              <div className="relative overflow-hidden h-52 bg-gray-100 dark:bg-gray-700">
                <img
                  ...
                  loading="lazy"
                />
                <span className="absolute top-2 left-2 rounded-full bg-[#8FA28A] px-2.5 py-0.5 text-[10px] font-semibold text-white shadow truncate max-w-[80%]">
                  {product.category}
                </span>
                <span className="absolute top-2 right-2 flex items-center gap-1 rounded-full bg-white/90 dark:bg-[#2d3d35]/90 px-2 py-0.5 text-[10px] font-bold text-gray-800 dark:text-white shadow">
                  <FaStar className="text-[#C8A96B] text-[9px]" />
                  {product.rating}
                </span>
              </div>
              ...
              <div className="flex flex-col flex-1 p-3 gap-1.5">
                ...
                <div className="flex items-center justify-between pt-2 border-t border-gray-100 dark:border-gray-700 mt-auto">
                  ...
                  <Link
                    ...
                    className="flex items-center gap-1 rounded-lg bg-[#8FA28A] px-2.5 py-1.5 text-xs font-semibold text-white hover:bg-[#6b8578] active:scale-95 transition-all duration-200 cursor-pointer shadow"
                  >
        ...
        <button
          ...
          className="hidden sm:flex absolute -right-4 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg items-center justify-center text-gray-700 dark:text-white hover:bg-[#8FA28A] hover:text-white hover:border-[#8FA28A] transition-all duration-300 cursor-pointer"
        >
          <svg
            className="w-4 h-4"
            fill="none"
      ...
      <div className="text-center mt-8">
        <Link
          to="/products"
          className="inline-flex items-center gap-2 dmsans text-sm font-semibold text-[#8FA28A] hover:text-[#6b8578] transition-colors"
        >
