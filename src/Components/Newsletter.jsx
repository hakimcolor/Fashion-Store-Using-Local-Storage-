...
// newsletter — email subscription section at the bottom of the home page
const Newsletter = () => {
  ...
  const handleSubscribe = (e) => {
    ...
    toast.success('subscribed successfully! welcome to OXISTYLE.');
    setEmail('');
  };
    ...
    <section className="py-16 max-w-[90%] mx-auto">
      ...
      >
        ...
        >
          ...
          <button
            type="submit"
            className="flex items-center gap-2 px-6 py-3.5 rounded-2xl bg-white font-semibold dmsans text-sm hover:bg-blue-50 active:scale-95 transition-all duration-200 cursor-pointer shadow-md whitespace-nowrap"
            style={{ color: '#155dfc' }}
          >
