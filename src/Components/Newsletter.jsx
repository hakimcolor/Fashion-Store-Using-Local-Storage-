    ...
    >
      ...
      >
        ...
        <div className="space-y-2 relative z-10">
          ...
          <p className="dmsans text-lg text-[#edf2ef] max-w-md mx-auto">
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="flex items-center gap-2 px-6 py-3.5 rounded-2xl bg-white font-semibold dmsans text-sm hover:bg-[#f5f8f6] active:scale-95 transition-all duration-200 cursor-pointer shadow-md whitespace-nowrap disabled:opacity-70"
            style={{ color: '#344E41' }}
          >
