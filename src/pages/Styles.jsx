...
const looks = [
  {
    id: 1,
    image: 'https://m.media-amazon.com/images/I/5120+fCqB6L._AC_SX569_.jpg',
  ...
  },
  {
    id: 2,
    image:
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQkAoBIEQsHgeXWBBLSbIlX1UKsWirSdg4e2yshxMtvRw&s',
  ...
  },
  {
    id: 3,
    image:
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRI3qLmxm6wYedQkN9FTn2fKvG99MevXJMmQz91FkotxQ&s=10',
  ...
  },
  {
    id: 4,
    image:
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTNhsc-Em-o_fPv3nmPR0LTF-7TC9kljWyoMkBjcHH-GA&s=10',
  ...
  },
  {
    id: 5,
    image:
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR_1bsuGrHJCC9F3lzZ0FdwMY8vdxhys2TllCf9F2Inbw&s',
  ...
  },
  {
    id: 6,
    image:
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTM1iQVy8kfX1PbvVVRPlFMmZrdZdhdQFCBN6qOv3WE_g&s=10',
  ...
  },
  {
    id: 7,
    image:
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRBsGE3xRE7jB2mJxWhxKpeykYOWPl-IrWobiTlpZHRHQ&s=10',
    ...
    <div>
      ...
      >
        ...
        <div className="max-w-[95%] mx-auto relative z-10" data-aos="fade-up">
          <span className="inline-block bg-white/20 backdrop-blur-sm px-5 py-2 rounded-full text-sm font-semibold mb-6 dmsans border border-[#C8A96B]/50">
          ...
          <p className="dmsans text-lg text-blue-100 max-w-2xl mx-auto">
            {lang === 'en'
              ? '8 curated fashion looks — from traditional Bangladeshi attire to modern streetwear.'
        ...
        <div className="max-w-[95%] mx-auto">
          ...
          <p className="dmsans text-blue-100 text-lg mb-8 max-w-xl mx-auto">
            {lang === 'en'
              ...
              : 'আমাদের পূর্ণ বাংলাদেশি ফ্যাশন সংগ্রহ ব্রাউজ করুন।'}
          </p>
          <Link
            to="/products"
