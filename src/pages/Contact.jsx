          ...
          <div data-aos="fade-left">
            ...
            >
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full flex items-center justify-center gap-2 py-4 bg-[#2d3d35] hover:bg-[#8FA28A] text-white font-semibold rounded-2xl dmsans transition-all duration-300 active:scale-[.98] shadow-lg cursor-pointer disabled:opacity-70"
              >
                {loading ? (
