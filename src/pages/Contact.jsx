    ...
    <div>
      ...
      <section className="relative h-72 md:h-96 overflow-hidden">
        ...
        >
          ...
          <p className="dmsans text-lg text-[#C7D3C0] max-w-xl">
            {tr('contact_sub', lang)}
          </p>
        </div>
      </section>
      ...
      {/* Features strip */}
      <section className="bg-gray-50 dark:bg-[#2d3d35] py-18 border-b border-gray-100 dark:border-gray-800">
      ...
      <section className="max-w-[95%] mx-auto py-16">
        <div className="text-center mb-10" data-aos="fade-up">
          ...
          <div className="flex items-center justify-center gap-3 mt-4">
            <span className="h-px w-16 bg-gradient-to-r from-transparent to-[#8FA28A]" />
            <span className="w-2 h-2 rounded-full bg-[#8FA28A]" />
            <span className="h-px w-16 bg-gradient-to-l from-transparent to-[#8FA28A]" />
          </div>
        </div>
        <div
        ...
        <div className="max-w-[95%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8" data-aos="fade-right">
                  ...
                  <div>
                    ...
                    {item.url ? (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="dmsans text-sm font-semibold text-gray-800 dark:text-white hover:text-[#8FA28A] transition-colors"
                      >
                        {item.value}
                      </a>
                    ) : (
            ...
            <div className="rounded-2xl overflow-hidden h-44 relative shadow-lg">
              ...
              />
              <div className="absolute inset-0 bg-[#8FA28A]/30 flex items-center justify-center">
                <div className="bg-white dark:bg-gray-800 px-5 py-3 rounded-2xl shadow-xl flex items-center gap-2">
                  <MdLocationOn className="text-[#8FA28A] text-xl" />
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white dmsans text-sm outline-none focus:border-[#8FA28A] focus:ring-2 focus:ring-[#8FA28A]/20 transition-all"
                  />
                </div>
                <div>
                  <label className="dmsans text-sm text-gray-600 dark:text-gray-400 mb-1 block">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white dmsans text-sm outline-none focus:border-[#8FA28A] focus:ring-2 focus:ring-[#8FA28A]/20 transition-all resize-none"
                />
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full flex items-center justify-center gap-2 py-4 bg-[#8FA28A] hover:bg-[#6b8578] text-white font-semibold rounded-2xl dmsans transition-all duration-300 active:scale-[.98] shadow-lg cursor-pointer disabled:opacity-70"
              >
                {loading ? (
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        >
          ...
          <p className="dmsans text-[#C7D3C0] text-lg mb-8 max-w-xl mx-auto">
            {lang === 'bn'
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 px-7 py-3.5 bg-[#25d366] text-white font-semibold rounded-2xl dmsans hover:bg-[#8FA28A] active:scale-95 transition-all shadow-xl cursor-pointer"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-7 py-3.5 bg-white text-[#8FA28A] font-semibold rounded-2xl dmsans hover:bg-[#F7F4ED] active:scale-95 transition-all shadow-xl cursor-pointer"
            >
              <FaEnvelope />
