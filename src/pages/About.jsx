    ...
    <div>
      ...
      >
        ...
        >
          ...
          <p className="dmsans text-lg text-[#C7D3C0] max-w-2xl mx-auto leading-relaxed">
          ...
          <div data-aos="fade-right">
            <div className="relative rounded-3xl overflow-hidden h-80 md:h-[450px] shadow-2xl">
              ...
              <div className="absolute bottom-6 left-6 text-white">
                ...
                <p className="dmsans text-sm text-[#C7D3C0]">
      ...
      <section className="max-w-[95%] mx-auto py-20">
        ...
        >
          <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[#8FA28A] to-[#6b8578] flex items-center justify-center text-white text-4xl font-bold arbutus-slab mx-auto mb-4 shadow-lg">
            H
          </div>
      ...
      >
        <div className="max-w-[95%] mx-auto">
          ...
          <p className="dmsans text-[#C7D3C0] text-lg mb-8 max-w-lg mx-auto">
